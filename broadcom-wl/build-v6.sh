...
find .  -not -name 'install' -not -name 'PKGBUILD' -not -name 'build-v*' -not -name 'modprobe.d*' -not -name '*.install' -not -name '*.patch' -not -name '*.png' -not -name '*.jpg' -not -name '*.cfg' -not -name '*.desktop' -delete
